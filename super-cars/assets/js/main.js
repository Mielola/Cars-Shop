...
function displayCar() {
    ...
    cars.forEach(item => {
        ...
        card.classList.add('bg-[#F7F7F8', 'border', 'rounded-xl', 'm-2', 'cards')
...
function displayCar2() {
    const container = document.getElementById('carContainer2')
    container.innerHTML = ''
    cars.forEach(item => {
        console.log(item)
        const card = document.createElement('div')
        ...
        card.innerHTML = `
                    <div class="p-3 bg-white rounded-md w-[400px]">
                        <div class="flex gap-2 backdrop-blur-lg bg-gray-400 w-fit items-center py-2 rounded-full px-3">
                            <img src="assets/image/Vector.png" alt="">
                            <p class="text-[12px]">Dealer Terverifikasi</p>
                        </div>
...
ScrollReveal().reveal('.cards', { delay: 200, distance: '100px' });
ScrollReveal().reveal('.sect-2', { delay: 200, distance: '100px' });
ScrollReveal().reveal('.sect-3', { delay: 200, distance: '100px' });
ScrollReveal().reveal('.sect-4', { delay: 200, distance: '100px' });
ScrollReveal().reveal('.dealer', { delay: 200, distance: '100px' });